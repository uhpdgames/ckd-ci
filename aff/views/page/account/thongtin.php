<div class="main_fix my-5">
    ...
    <div class="my_voucher_new">
        <div class="wp">
            ...
            <ul class="bc_voucher_list" id="list-vouchers-main">
                <li class="bc_voucher_item row flex-wrap g-2">
                    <a
                            href="<?= site_url('san-pham') ?>"
                            class="bc_voucher_logo"" rel="nofollow"> <img
                        ...
                        <div class="bc_voucher_content">
                            <div class="bc_voucher_content_main mt-2">
                                ...
                                <div class="bc_voucher_title"><span class="bc_voucher_label"
                                    ...
                                    <span>
                                          ...
                                          <?= getLang('text_voucher') .$voucher['discount_percentage']. '%'?></span></div>


                                <div class="copy-text">
                                    <input type="text" class="text" value="<?=$voucher?>" />
                            ...
                            <div class="bc_voucher_action">
                                ...
                                <div class="bc_voucher_buttons">
                                    <a
                                            class="bc_voucher_button bc_voucher_copy"
                                            href="<?= site_url('san-pham') ?>"
    ...
    <div class="wrap-user">
        ...
        <form class="form-user validation-user" novalidate method="post" action="account/thong-tin"
            ...
            <div class="input-group input-user">
                ...
                <input type="text" class="form-control" id="username" name="username"
                       placeholder="<?= getLang('nhaptaikhoan') ?>" value="<?= $row_detail['username'] ?>" readonly
                       required>
            </div>
            ...
            <div class="input-group input-user">
                <div class="radio-user custom-control custom-radio">
                    <input type="radio" id="nam" name="gioitinh"
                           class="custom-control-input" <?= $row_detail['gioitinh'] == 1 ? 'checked' : '' ?> value="1"
                           required>
                    <label class="custom-control-label" for="nam"><?= getLang('nam') ?></label>
                </div>
                <div class="radio-user custom-control custom-radio">
                    <input type="radio" id="nu" name="gioitinh"
                           class="custom-control-input" <?= $row_detail['gioitinh'] == 2 ? 'checked' : '' ?> value="2"
                           required>
            ...
            <div class="input-group input-user">
                ...
                <input type="text" class="form-control" id="ngaysinh" name="ngaysinh"
                       ...
                       value="<?= date("d/m/Y", $row_detail['ngaysinh']) ?>" required>
            ...
            <div class="themdiachi">
                <?php
                $user_dc = $d->rawQuery("select tenvi from #_news where id_user='" . $_SESSION[$login_member]['id'] . "' and type = ? and hienthi > 0", array('user'));
                foreach ($user_dc as $k => $v) { ?>
                    <div class="input-group input-user">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><i class="fa fa-map"></i></div>
                        </div>
                        <input type="text" class="form-control" name="diachi2[]"
                               placeholder="<?= getLang('nhapdiachi') ?>" value="<?= $v['tenvi'] ?>"><span
                                class="dlt_dc"><i class="fas fa-trash-alt"></i></span></div>
                <?php } ?>
            </div>

            <p class="c_themdiachi tdtt">+ <?= getLang('themdiachi') ?></p>
    ...
    setTimeout(function () {
        $(document).ready(function () {
			...
			$('.c_themdiachi').click(function () {
                $('.themdiachi').append('<div class="input-group input-user"><div class="input-group-prepend"><div class="input-group-text"><i class="fa fa-map"></i></div></div><input type="text" class="form-control" name="diachi2[]" placeholder="<?=getLang('nhapdiachi')?>"><span class="dlt_dc"><i class="fas fa-trash-alt"></i></span></div>');
                return false;
            })
