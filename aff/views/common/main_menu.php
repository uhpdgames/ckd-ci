<div class="top-area">
            ...
            <div class="site-wrap">
                <div class="log">
                    ...
                    <div class="ngonngu pt-2 mr-4">
                        ...
                        <a data-lang_dir="english" data-lang="en" href="<?= site_url(); ?>"><img src="<?=image_default('en')?>" alt="English" /></a>
                        ...
                        <a href="<?= site_url(); ?>" style="pointer-events: none;" title="China" class="flag zh-CN">
                            <img src="<?=image_default('cn')?>" border="0" style="opacity: 0.5; filter: alpha(opacity=50); pointer-events: none; cursor: default;" />
                        </a>
                        <a href="<?= site_url(); ?>" style="pointer-events: none;" title="Malaysia" class="flag ma">
                            <img src="<?=image_default('ma')?>" border="0" style="opacity: 0.5; filter: alpha(opacity=50); pointer-events: none; cursor: default;" />
                        </a>
                    </div>
    ...
    <?php
	   $this->load->view('common/menu_pc', $this->data);
