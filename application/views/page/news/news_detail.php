        ...
        <div class="col-12 col-lg-3 m-md-0 p-md-0">
            <div class="ckd-blog">
                <div class="news-latest">
                    <div class="sidebarblog-title title_block" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true" aria-controls="collapseExample" style="cursor: pointer;">
                        <h2>
                            <?= getLang('tintucnoibat') ?>
                        </h2>
                    </div>
                        ...
                        <div class="w-100 item-article clearfix">
                            <?php
								...
								if (is_array($news) && count($news)) {
									foreach ($news as $k =>
                            $v) { // qq(UPLOAD_NEWS_L . $value['photo']); ?>
                            <div class="w-100 d-flex flex-row flex-wrap h-rem align-items-center text-left">
                                <div class="post-image">
                                    <div class="zoom_hinh item_img">
                                        <a href="<?php echo $router . '/' . $v[$sluglang] ?>"> <img class="img-fluid" src="<?php echo UPLOAD_NEWS_L . $v['photo']; ?>" alt="<?= $v['ten'] ?>" /></a>
                                    </div>
                                </div>

                                <div class="post-content">
                                    <h3>
                                        <a class="name_post catchuoi2" href="<?php echo $router . '/' . $v[$sluglang] ?>"><?= ucfirst(mb_strtolower($v['ten'])) ?></a>
                                    </h3>
		...
		<div class="main_fix">
			...
			<div class="othernews list-news-latest layered">
				<b class="my-2"><?php echo getLang('baivietkhac') ?>:</b>
					...
					//qq($id);
					foreach ($news as $k =>
								   $v) { if ($v['id'] == $id) continue; ?>


						<div class="row border-bottom-1 my-2 align-items-end">
							<div class="col-md-1 py-1 pc">
								<div class="item_img">
									<a href="<?php echo $router . '/' . $v[$sluglang] ?>"> <img style="width: 100%; height: auto; object-fit: cover; transform: scale(1);" class="img-fluid" src="<?php echo UPLOAD_NEWS_L . $v['photo']; ?>" alt="<?= $v['ten'] ?>" /></a>
								</div>
							</div>
