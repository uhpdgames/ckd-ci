...
class Product extends MY_Controller
{
	...
	public function index()
	{
		...
		if (!empty($keyword)) {
			...
			$sql = "select hethang, photo, ten$lang as ten, tenkhongdauvi, tenkhongdauen, giamoi, gia, giakm, id, moi, mota$lang as mota, soluong from #_product where $where order by stt,id desc $limit";
			...
			$this->data['title_cat'] = getLang('sanpham');

			$this->data['product'] = $product;
			$this->data['paging'] = $paging;
			$this->data['breadcr'] = create_BreadCrumbs($this->com, 'san');
