...
$linkDelete = "index.php?com=affiliate&act=delete&p=".$curPage;
$linkDetails = "index.php?com=affiliate&act=ref";
?>
                ...
                <?php } else { ?>
                    ...
                    <?php for($i=0;$i<count($items);$i++) { ?>
                        <tr>
                            ...
                            <td class="align-middle">
                                <a class="text-dark" href="<?=$linkDetails?>&uid=<?=$items[$i]['id']?>" title="<?=$items[$i]['username']?>"><?=$items[$i]['username']?></a>
                            </td>
                            <td class="align-middle">
                                <a class="text-dark" href="<?=$linkDetails?>&uid=<?=$items[$i]['id']?>" title="<?=$items[$i]['ten']?>"><?=$items[$i]['ten']?></a>
                            </td>
                            <td class="align-middle">
                                <a class="text-dark" href="<?=$linkDetails?>&uid=<?=$items[$i]['id']?>" title="<?=$items[$i]['email']?>"><?=$items[$i]['email']?></a>
                            </td>
