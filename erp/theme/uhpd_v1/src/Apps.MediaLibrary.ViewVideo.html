        ...
        <div class="container-fluid library-app">
            ...
            <div class="row">
                <div class="col-12 col-xl-4">
                    <div class="card preview-area d-flex flex-column">
                        <div class="position-relative">

                            <div class="video-view">
                                <video id="my-video" class="video-js card-img-top" controls preload="auto"
                                    poster="img/video/big-buck-bunny-poster.jpg" data-setup="{}">
                                    <source
