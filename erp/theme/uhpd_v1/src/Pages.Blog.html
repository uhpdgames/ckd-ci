        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 mb-5">
                    <div class="card flex-row listing-card-container">
                        <div class="w-40 position-relative">
                            <a href="Pages.Blog.Detail.html" class="video-play-icon">
                                <span></span>
                            </a>
                            <img class="card-img-left" src="img/details/small-2.jpg" alt="Card image cap">
                        </div>
                        <div class="w-60 d-flex align-items-center">
                            <div class="card-body">
                                <a href="Pages.Blog.Detail.html">
                ...
                <div class="col-12 col-lg-6 mb-5">
                    <div class="card flex-row listing-card-container">
                        <div class="w-40 position-relative">
                            <a href="Pages.Blog.Detail.html">
                                <img class="card-img-left" src="img/details/small-3.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="w-60 d-flex align-items-center">
                            <div class="card-body">
                ...
                <div class="col-12 col-lg-6 mb-5">
                    <div class="card flex-row listing-card-container">
                        <div class="w-40 position-relative">
                            <a href="Pages.Blog.Detail.html">
                                <img class="card-img-left" src="img/details/small-7.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="w-60 d-flex align-items-center">
                            <div class="card-body">
                ...
                <div class="col-12 col-lg-6 mb-5">
                    <div class="card flex-row listing-card-container">
                        <div class="w-40 position-relative">
                            <a href="Pages.Blog.Detail.html">
                                <img class="card-img-left" src="img/details/small-1.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="w-60 d-flex align-items-center">
                            <div class="card-body">
                ...
                <div class="col-12 col-lg-6 mb-5">
                    <div class="card flex-row listing-card-container">
                        <div class="w-40 position-relative">
                            <a href="Pages.Blog.Detail.html">
                                <img class="card-img-left" src="img/details/small-6.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="w-60 d-flex align-items-center">
                            <div class="card-body">
                ...
                <div class="col-12 col-lg-6 mb-5">
                    <div class="card flex-row listing-card-container">
                        <div class="w-40 position-relative">
                            <a href="Pages.Blog.Detail.html">
                                <img class="card-img-left" src="img/details/small-8.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="w-60 d-flex align-items-center">
                            <div class="card-body">
