        ...
        <div class="container-fluid disable-text-selection">
            ...
            <div class="row">
                <div class="col-12 list" data-check-all="checkAll">
                    ...
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="Pages.Product.Detail.html">
                            <img src="img/products/goose-breast-thumb.jpg" alt="Goose Breast"
                                class="list-thumbnail responsive border-0 card-img-left" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                    ...
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="Pages.Product.Detail.html">
                            <img src="img/products/petit-gateau-thumb.jpg" alt="Petit Gateau"
                                class="list-thumbnail responsive border-0 card-img-left" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                    ...
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="Pages.Product.Detail.html">
                            <img src="img/products/salzburger-nockerl-thumb.jpg" alt="Salzburger Nockerl"
                                class="list-thumbnail responsive border-0 card-img-left" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
                    ...
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex" href="Pages.Product.Detail.html">
                            <img src="img/products/napoleonshat-thumb.jpg" alt="Napoleonshat"
                                class="list-thumbnail responsive border-0 card-img-left" />
                        </a>
                        <div class="pl-2 d-flex flex-grow-1 min-width-zero">
                            <div
