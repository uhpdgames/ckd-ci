                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Cheesecake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cakes</p>
                                    <p class="mb-4 text-small">Wedding cake with flowers Macarons and blueberries</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Marble Cake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cupcakes</p>
                                    <p class="mb-4 text-small">Cheesecake with chocolate cookies and Cream biscuits</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            ...
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Fruitcake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cakes</p>
                                    <p class="mb-4 text-small">Homemade cheesecake with fresh berries and mint</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Chocolate Cake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cupcakes</p>
                                    <p class="mb-4 text-small">Chocolate cake with berries</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">White Cake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cupcakes</p>
                                    <p class="mb-4 text-small">Chocolate cake with mascarpone</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Cake with Icecream</p>
                                    <p class="mb-1 text-muted text-small">Products | Cakes</p>
                                    <p class="mb-4 text-small">Wedding cake decorated with donuts and wild berries</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Cheesecake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cupcakes</p>
                                    <p class="mb-4 text-small">Cheesecake with fresh berries and mint for dessert</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Fruitcake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cakes</p>
                                    <p class="mb-4 text-small">Delicious vegan chocolate cake</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Tea Cake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cakes</p>
                                    <p class="mb-4 text-small">White chocolate strawberry yogurt cake decorated with
                                        fresh fruits and chocolate</p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div>
                                <a href="#">
                                    <p class="list-item-heading mb-1 color-theme-1">Marble Cake</p>
                                    <p class="mb-1 text-muted text-small">Products | Cakes</p>
                                    <p class="mb-4 text-small">Christmas fruit cake, pudding on top</p>
                                </a>
                            </div>
                        </div>
                    </div>
