            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-5">
                        <div class="card-body">
                            <p>
                                Mailing templates use inline styling and table layout to be displayed well at various
                                service providers. To prevent the template inheriting some styles from the project
                                stylesheets, we included it as an iframe. You may use below button to view standalone
                                version.
                            </p>
                            <a class="btn btn-primary" target="_blank"
                                href="Pages.Misc.Mailing.Standalone.html">Standalone
                                Version</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 mb-5">
                    <iframe id="idIframe" onload="iframeLoaded()"
                        style="border: initial; width:100%; overflow: hidden; display: block"
                        src="Pages.Misc.Mailing.Standalone.html"></iframe>
                </div>
            </div>
        </div>
    </main>
