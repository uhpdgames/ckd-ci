                            ...
                            <div class="glide gallery mb-4">
                                <div class="glide__track" data-glide-el="track">
                                    <div class="glide__slides">
                                        <a href="img/details/1.jpg">
                                            <img class="card-img" src="img/details/small-1.jpg" alt="First image">
                                        </a>
                                        <a href="img/details/2.jpg">
                                            <img class="card-img" src="img/details/small-2.jpg" alt="Second image">
                                        </a>
                                        <a href="img/details/3.jpg">
                                            <img class="card-img" src="img/details/small-3.jpg" alt="Third image">
                                        </a>
                                        <a href="img/details/2.jpg">
                                            <img class="card-img" src="img/details/small-2.jpg" alt="Fourth image">
                                        </a>
                                        <a href="img/details/3.jpg">
                                            <img class="card-img" src="img/details/small-3.jpg" alt="Fifth image"
                                                >
                                        </a>
                                    </div>
                                </div>
