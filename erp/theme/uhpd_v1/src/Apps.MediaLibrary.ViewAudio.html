        ...
        <div class="container-fluid library-app">
            ...
            <div class="row">
                <div class="col-12 col-xl-4">
                    <div class="card preview-area preview-area-audio d-flex flex-column flex-xl-column">
                        <div class="position-relative">

                            <div class="audio-view">
                                <audio id="myAudio" class="video-js audio" controls preload="auto" data-setup="{}">
                                    <source
                                        src="http://contentdownload.elitenet.dk/published/4peterbillelarsensonatas.mp3"
                                        type='audio/mp3'>
                                </audio>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-3">commercial-back.mp3</p>
                            <p class="text-muted text-small mb-1">Length</p>
                            <p class="mb-3">03:22</p>
                            <p class="text-muted text-small mb-1">Size</p>
                            <p class="mb-0">2.024 KB</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xl-8 list disable-text-selection" data-check-all="checkAll">
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-xl-6 col-12">
                            <div class="card d-flex flex-row mb-4 media-thumb-container active-default">
                                <a class="d-flex align-self-center media-thumbnail-icon"
                                    href="Apps.MediaLibrary.ViewAudio.html">
                                    <i class="iconsminds-guitar"></i>
                                </a>
