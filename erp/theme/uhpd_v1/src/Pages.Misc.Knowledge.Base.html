            ...
            <div class="row equal-height-container">
                    ...
                    <div class="card">
                        <div class="card-body pt-5 pb-5 d-flex flex-column">
                            <div class="text-center">
                                <i class="iconsminds-director large-icon"></i>
                                <h5 class="mb-0 font-weight-semibold color-theme-1 mb-4">USING DORE</h5>
                            </div>
                            <div class="pl-3 pr-3 pt-3 pb-0 d-flex flex-column flex-grow-1">
                                <p class="text-muted mb-4">Systems thinking correlation, social impact; when
                                    revolutionary
                                    fully ethical life bandwidth and thought partnership.</p>
                                <ul class="list-unstyled mb-0">
                                    <li><a href="#" class="btn-link">Getting Started</a></li>
                                    <li><a href="#" class="btn-link">Game Changing Features</a>
                                    </li>
                ...
                <div class="col-md-12 col-xl-6 mb-4 col-item">
                    <div class="card">
                        <div class="card-body pt-5 pb-5 d-flex flex-column">
                            <div class="text-center">
                                <i class="iconsminds-security-settings large-icon"></i>
                                <h5 class="mb-0 font-weight-semibold color-theme-1 mb-4">SECURITY</h5>
                            </div>
                            <div class="pl-3 pr-3 pt-3 pb-0 d-flex flex-column flex-grow-1">
                                <p class="text-muted mb-4">Systems thinking correlation, social impact; when
                                    revolutionary
                                    fully ethical life bandwidth and thought partnership.</p>
                                <ul class="list-unstyled mb-0">
                                    <li><a href="#" class="btn-link">Securing Your Account</a>
                                    </li>
                    ...
                    <div class="card">
                        <div class="card-body pt-5 pb-5 d-flex flex-column">
                            <div class="text-center">
                                ...
                                <h5 class="mb-0 font-weight-semibold color-theme-1 mb-4">ACCOUNT</h5>
                            </div>
                            <div class="pl-3 pr-3 pt-3 pb-0 d-flex flex-column flex-grow-1">
                                <p class="text-muted mb-4">Systems thinking correlation, social impact; when
                                    revolutionary
                                    fully ethical life bandwidth and thought partnership.</p>
                                <ul class="list-unstyled mb-0">
                                    <li><a href="#" class="btn-link">Login and Register</a></li>
                                    <li><a href="#" class="btn-link">Password Reset</a></li>
                                    <li><a href="#" class="btn-link">Devices</a></li>
                                    <li><a href="#" class="btn-link">Integrations</a></li>
                                    <li><a href="#" class="btn-link">Notifications</a></li>
                                    <li><a href="#" class="btn-link">Messages</a></li>
                                    <li><a href="#" class="btn-link">Blocking Users</a></li>
                                    <li><a href="#" class="btn-link">Following Users</a></li>
                                    <li><a href="#" class="btn-link">Login</a></li>
                                    <li><a href="#" class="btn-link">Content Filters</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-xl-6 mb-4 col-item">
                    <div class="card">
                        <div class="card-body pt-5 pb-5 d-flex flex-column">
                            <div class="text-center">
                                <i class="iconsminds-newspaper large-icon"></i>
                                <h5 class="mb-0 font-weight-semibold color-theme-1 mb-4">POLICIES</h5>
                            </div>
                            <div class="pl-3 pr-3 pt-3 pb-0 d-flex flex-column flex-grow-1">
                                <p class="text-muted mb-4">Systems thinking correlation, social impact; when
                                    revolutionary
                                ...
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li><a href="#" class="btn-link">Policies</a></li>
                                    <li><a href="#" class="btn-link">Privacy</a></li>
                                    <li><a href="#" class="btn-link">Ad Choices</a></li>
                                    <li><a href="#" class="btn-link">Researches and
                                            Experiments</a></li>
                                    <li><a href="#" class="btn-link">General Guidelines</a></li>
                                    <li><a href="#" class="btn-link">Cookies</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
