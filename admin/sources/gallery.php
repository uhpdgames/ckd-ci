<?php
	...
	function save_photo()
	{
		...
		$dataMulti = array();
		$dataMulti['tenvi'] = (isset($_POST['tenvi'])) ? $_POST['tenvi'] : null;;
		$dataMulti['motavi'] =  (isset($_POST['motavi'])) ? $_POST['motavi'] : null;
		$dataMulti['link_video'] =  (isset($_POST['link_video'])) ? $_POST['link_video'] : null;;
		...
		else
		{
			...
			if($numberPhoto && $dataMultiTemp)
			{
				...
				//	$dataMulti = $dataMultiTemp[$i];
					...
					$dataMulti['hienthi'] = 1;
					//$dataMulti['stt'] =$dataMultiTemp[0]['stt'];
