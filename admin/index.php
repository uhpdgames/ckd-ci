...
if (isset($_GET['ngonnguadmin'])) {
    $_SESSION['langadmin'] = $_GET['ngonnguadmin'];
}

if (!isset($_SESSION['langadmin'])) {
    $_SESSION['langadmin'] = 'vi';
}
$langadmin = $_SESSION['langadmin'];
require_once LIBRARIES . "lang/langadmin$langadmin.php";
...
$_Affiliate = new Affiliate($d, true);
...
<head>
	...
	<script type="text/javascript" src="assets/js/jquery.min.js?v=<?=rand(0,99999)?>"></script>
    ...
    <!--<link href="<?php /*echo $config_base */?>admin/assets/css/style.css" rel="stylesheet">-->
    ...
    <?php include TEMPLATE . LAYOUT . 'theme/header.php' ?>
...
<?php if (isset($_SESSION[$login_admin]['active']) && ($_SESSION[$login_admin]['active'] == true)) { ?>
    ...
    include TEMPLATE . LAYOUT . 'theme/sidebar.php'
    ?>
        ...
        <?php if ($alertlogin) { ?>
            <section class="content">
                <div class="container-fluid">
                    <div role="alert" class="alert alert-danger bg-danger text-light border-0 alert-dismissible fade show my-3">
...
<?php include TEMPLATE . LAYOUT . 'theme/footer.php' ?>
</body>
</html>
