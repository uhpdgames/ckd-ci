...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
			...
			<code style="color:palevioletred">Hình ảnh là các chuỗi mã hóa, vui lòng liên hệ lập trình viên để xử lý. </code>
        </div>
                            ...
                            <tr>
                                ...
                                <?php if(isset($config['photo']['man_photo'][$type]['avatar_photo']) && $config['photo']['man_photo'][$type]['avatar_photo'] == true) { ?>
	                                <td class="align-middle text-center">
	                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>">
                                            <img class="rounded img-preview" src="<?=$config_base;?>upload/photo/<?=$items[$i]['photo']?>" alt="<?=$items[$i]['tenvi']?>"/>
                                        </a>

                                        <!--

                                        <img class="rounded img-preview" onerror="src='assets/images/noimage.webp'" src="<?php /*=THUMBS*/?>/<?php /*=$config['photo']['man_photo'][$type]['thumb_photo']*/?>/<?php /*=UPLOAD_PHOTO_L.$items[$i]['photo']*/?>" alt="<?php /*=$items[$i]['tenvi']*/?>"></a>-->
