...
<section class="content">
    <form method="post" id="form-watermark" action="<?=$linkSave?>" enctype="multipart/form-data">
        <div class="card-footer text-sm sticky-top">
            <button type="submit" class="btn btn-warning rounded-pill"><i class="far fa-save mr-2"></i>Lưu</button>
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php if(isset($config['photo']['photo_static'][$type]['images']) && $config['photo']['photo_static'][$type]['images'] == true) { ?>
                    <div class="form-group">
                        <label class="change-photo" for="file">
                            <p>Upload hình ảnh:</p>
                            <div class="rounded">
                                <img class="rounded img-upload"  onerror="src='assets/images/noimage.webp'"  src="<?=$config_base;?>upload/photo/<?=$item['photo']?>" alt="Alt Photo"/>
                             <!--
                                <img class="rounded img-upload" src="<?php /*=THUMBS*/?>/<?php /*=$config['photo']['photo_static'][$type]['thumb']*/?>/<?php /*=UPLOAD_PHOTO_L.$item['photo']*/?>" onerror="src='assets/images/noimage.webp'" alt="Alt Photo"/>
                             -->
                                <strong>
                ...
                <?php if(isset($config['photo']['photo_static'][$type]['watermark-advanced']) && $config['photo']['photo_static'][$type]['watermark-advanced'] == true) { ?>
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="watermark-position rounded">
                                    <label for="tl">
                                        ...
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($tl) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="tc">
                                        <input type="radio" name="data[options][watermark][position]" id="tc" value="2" <?=$tc?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($tc) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="tr">
                                        <input type="radio" name="data[options][watermark][position]" id="tr" value="3" <?=$tr?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($tr) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="mr">
                                        <input type="radio" name="data[options][watermark][position]" id="mr" value="4" <?=$mr?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($mr) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="br">
                                        <input type="radio" name="data[options][watermark][position]" id="br" value="5" <?=$br?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($br) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="bc">
                                        <input type="radio" name="data[options][watermark][position]" id="bc" value="6" <?=$bc?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($bc) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="bl">
                                        <input type="radio" name="data[options][watermark][position]" id="bl" value="7" <?=$bl?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($bl) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="ml">
                                        <input type="radio" name="data[options][watermark][position]" id="ml" value="8" <?=$ml?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($ml) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                    <label for="cc">
                                        <input type="radio" name="data[options][watermark][position]" id="cc" value="9" <?=$cc?>>
                                        <img class="rounded" onerror="src='assets/images/noimage.webp'" src="<?=($cc) ? $watermark : ''?>" alt="watermark-cover">
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <a class="btn btn-success rounded-pill mb-3" href="javascript:previewWatermark();"><i class="fas fa-photo-video mr-2"></i>Preivew</a>
                <?php } ?>
                <div class="row">
                        ...
                        <div class="form-group">
                            <label class="change-photo" for="file">
                                ...
                                <div class="rounded">
                                    ...
                                    <strong>
                                        <b class="text-sm text-split"></b>
                                        <span class="btn btn-success rounded-pill"><i class="fas fa-camera mr-2"></i>Chọn file mp3</span>
                                    </strong>
                                </div>
                            </label>
