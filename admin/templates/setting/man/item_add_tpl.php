...
<section class="content">
	<form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<?php } ?>
						...
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control" name="data[options][video]" id="video" placeholder="video" value="<?=$options['video']?>">
						</div>
	    ...
	    <div class="card card-primary card-outline text-sm">
	        <div class="card-header">
	            <h3 class="card-title">Nội dung Bộ Công Thương</h3>
	            <a class="btn btn-success rounded-pill d-inline-block text-white float-right create-seo" title="Tạo SEO">Tạo nôi dung</a>
	        </div>
	        <div class="card-body">
                <div class="form-group">
                    <label for="mastertool">Nội dung:</label>
                    <textarea class="form-control" name="data[bocongthuong]" rows="3"><?=htmlspecialchars_decode(@$item['bocongthuong'])?></textarea>
                </div>
	        </div>
	    </div>
