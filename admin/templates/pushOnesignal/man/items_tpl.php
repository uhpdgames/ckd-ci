                        ...
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['name']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.webp'" src="<?=THUMBS?>/100x100x1/<?=UPLOAD_SYNC_L.$items[$i]['photo']?>" alt="<?=$items[$i]['name']?>"></a>
                                </td>
                                <td class="align-middle">
                                    <a class="text-dark" href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['name']?>"><?=$items[$i]['name']?></a>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="btn btn-success rounded-pill text-white" id="push-onesignal" data-url="index.php?com=pushOnesignal&act=sync&id=<?=$items[$i]['id']?>" title="Đẩy tin"><i class="fas fa-paper-plane mr-2"></i>Đẩy tin</a>
                                </td>
                                <td class="align-middle text-center text-md text-nowrap">
