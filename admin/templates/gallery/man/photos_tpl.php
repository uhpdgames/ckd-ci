...
<section class="content">
    <div class="card-footer text-sm sticky-top">
        ...
        <a class="btn btn-info rounded-pill" href="<?=$linkParent?>" title="Thoát"><i class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
    </div>
                            ...
                            <tr>
                                ...
                                <?php if(isset($config[$com][$type][$dfgallery][$val]['avatar_photo']) && $config[$com][$type][$dfgallery][$val]['avatar_photo'] == true) { ?>
	                                <td class="align-middle text-center">
	                                    <a href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tenvi']?>"><img class="rounded img-preview" onerror="src='assets/images/noimage.webp'" src="<?=THUMBS?>/<?=$config[$com][$type][$dfgallery][$val]['thumb_photo']?>/<?="upload/".$com."/".$items[$i]['photo']?>" alt="<?=$items[$i]['tenvi']?>"></a>
	                                </td>
	                            <?php } ?>
                                <?php if(isset($config[$com][$type][$dfgallery][$val]['tieude_photo']) && $config[$com][$type][$dfgallery][$val]['tieude_photo'] == true) { ?>
	                                <td class="align-middle">
                                ...
                                <?php if(isset($config[$com][$type][$dfgallery][$val]['cart_photo']) && $config[$com][$type][$dfgallery][$val]['cart_photo'] == true) { ?>
						        	<td class="align-middle">
										...
										<?php } else { ?>
											<img class="rounded img-preview" onerror="src='assets/images/noimage.webp'" src="<?=UPLOAD_COLOR.$mauDetail['photo']?>" alt="<?=$mauDetail['tenvi']?>">
										<?php } ?>
						        	</td>
						        <?php } ?>
						        <?php if(isset($config[$com][$type][$dfgallery][$val]['file_photo']) && $config[$com][$type][$dfgallery][$val]['file_photo'] == true) { ?>
						        	<td class="align-middle">
						        		<?php if(isset($items[$i]['taptin']) && ($items[$i]['taptin'] != '')) { ?>
											<a class="btn btn-primary rounded-pill d-inline-block p-1 rounded" href="<?=UPLOAD_FILE.$items[$i]['taptin']?>" title="Download tập tin"><i class="fas fa-download mr-2"></i>Download tập tin</a>
										<?php } else { ?>
