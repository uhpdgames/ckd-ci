        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <?php if(isset($config[$com][$type][$dfgallery][$val]['images_photo']) && $config[$com][$type][$dfgallery][$val]['images_photo'] == true) { ?>
                    <div class="form-group">
                        <label class="change-photo" for="file">
                            <p>Upload hình ảnh:</p>
                            <div class="rounded">
                                <img class="rounded img-upload" src="<?="../upload/".$com."/".$item['photo']?>" onerror="src='assets/images/noimage.webp'" alt="Alt Photo"/>
                                <strong>
                ...
                <?php if(isset($config[$com][$type][$dfgallery][$val]['sao_photo']) && $config[$com][$type][$dfgallery][$val]['sao_photo'] == true) { ?>
                    <div class="form-group">
                        <label for="link_video">Số sao:</label>
                        <input type="text" class="form-control" name="data[link_video]" id="link_video" placeholder="Số sao" value="<?=@$item['link_video']?>">
                    </div>
                <?php } ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php if(isset($config[$com][$type][$dfgallery][$val]['mota_photo']) && $config[$com][$type][$dfgallery][$val]['mota_photo'] == true) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control for-seo" name="data[mota<?=$k?>]" id="mota<?=$k?>" rows="5" placeholder="Đánh giá"><?=htmlspecialchars_decode(@$item['mota'.$k])?></textarea>
                                            </div>
                                        <?php } ?>
