	            ...
	            <div class="card-body">
					<?php if(isset($config[$com][$type][$dfgallery][$val]['images_photo']) && $config[$com][$type][$dfgallery][$val]['images_photo'] == true) { ?>
	                    <div class="form-group">
						    <label class="change-photo" for="file<?=$i?>">
						        <p>Upload hình ảnh:</p>
						        <div class="rounded">
						            <img class="rounded img-upload" src="" onerror="src='assets/images/noimage.webp'" alt="Alt Photo"/>
						            <strong>
		            ...
		            <?php if(isset($config[$com][$type][$dfgallery][$val]['video_photo']) && $config[$com][$type][$dfgallery][$val]['video_photo'] == true) { ?>
		                <div class="form-group">
		                    ...
		                    <input type="text" class="form-control" name="link_video" id="link_video<?=$i?>" onchange="youtubePreview(this.value,'#loadVideo<?=$i?>');" placeholder="Video">
		                </div>
		                <div class="form-group">
		            ...
		            <?php if(isset($config[$com][$type][$dfgallery][$val]['sao_photo']) && $config[$com][$type][$dfgallery][$val]['sao_photo'] == true) { ?>
		                <div class="form-group">
		                    <label for="link_video<?=$i?>">Số sao:</label>
		                    <input type="text" class="form-control" name="dataMulti[<?=$i?>][link_video]" id="link_video<?=$i?>"  placeholder="Số sao">
		                </div>
		            <?php } ?>
		                                ...
		                                <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>-<?=$i?>" role="tabpanel" aria-labelledby="tabs-lang">
		                                    <?php if(isset($config[$com][$type][$dfgallery][$val]['tieude_photo']) && $config[$com][$type][$dfgallery][$val]['tieude_photo'] == true) { ?>
		                                        <div class="form-group">
		                                            ...
		                                            <input type="text" class="form-control" name="ten<?=$k?>" id="ten<?=$k?><?=$i?>" placeholder="Tiêu đề (<?=$k?>)">
		                                        </div>
		                                    <?php } ?>
		                                    ...
		                                    <div class="form-group">
                                                <label for="mota<?=$k?>">Đánh giá (<?=$k?>):</label>
                                                <textarea class="form-control for-seo" name="mota<?=$k?>" id="mota<?=$k?><?=$i?>" rows="5" placeholder="Đánh giá"></textarea>
                                            </div>
